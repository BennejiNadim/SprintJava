 ...
 * @author USER
 */
public class ModifierEtatvController implements Initializable {
    ...
    private void Confirmer(ActionEvent event) {
          if (!v1.getEtat().toString().equals(etatc.getValue())) {
        if (se.testTextInput(e)) {
            if (se.testFloatInput(prix.getText())) {
                if (e.equals(Equipement.etat.disponnible.toString()) || e.equals(Equipement.etat.vendu.toString())) {
                    sv.changerEtat(FrontController.id_courant, se.stringToEtat(etatc.getValue().toString()), Float.parseFloat(prix.getText()));
                } else {
                    sv.changerEtat(FrontController.id_courant, se.stringToEtat(etatc.getValue().toString()), 0f);
                }
                ...
                try {
                    ...
                    Logger.getLogger(ModifierEtatvController.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
